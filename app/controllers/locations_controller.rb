class LocationsController < ApplicationController
  ...
  # added all this in class on 9.14.15
  def show
  ...
  # We are not going to add a bus unless there is one nearby. change long and lat from API date to float. Going to add a bus to the count as long as there is one nearby. Pushing data into array, which is what we are showing the user.
    @buses.each do |bus|
